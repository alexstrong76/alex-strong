...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Generate an HTML Sankey of U.S. wealth by federal income tax bracket."
    )
    parser.add_argument(
        "--output",
...
def main() -> int:
    ...
    print("Tip: run with `python3 create_wealth_sankey.py` (do not paste script source into bash).")
    return 0
